                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    ...
                                    <span%>{{ round((($product->regular_price -
                                        $product->sale_price)/$product->regular_price)*100) }}% off</span>
                                        @else
                                ...
                                <div class="mt-2 mt-md-3 border-product">
                                    <h6 class="product-title hurry-title d-block"></h6>
                                    <div class="progress">
                            ...
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="{{route('shop.product.details',['slug'=>$rproduct->slug])}}">
                                        ...
                                        class="img-fluid blur-up lazyload" alt="{{ $rproduct->name }}"
